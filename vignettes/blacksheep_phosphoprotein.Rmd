...
when useing the <aggregate_features> parameter
...
grab the desired analysis. `type` is either `table` or `heatmap` and specifies 
which analysis type that you want to grab.
```{r}
...
appears in is indicative of the measure of the gene being higher in group1 or 
group2.
